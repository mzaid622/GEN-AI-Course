...
llm = HuggingFaceEndpoint(repo_id="Qwen/Qwen2.5-32B-Instruct", task="text-generation")
...
strucuted_model = model.with_structured_output(Review)

result = strucuted_model.invoke(
